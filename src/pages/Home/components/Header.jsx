    ...
    return (
        <section className="flex flex-col md:flex-row items-center justify-between px-6 md:px-40 py-40 bg-white">
            ...
            <div className="max-w-4xl md:w-1/2">
                ...
                <p className="mt-6 text-gray-600 text-base md:text-lg  leading-relaxed text-justify w-[500px]">
                ...
                <button className="mt-8 bg-[#e60023] text-white px-20 py-4 text-[20px] rounded-lg font-semibold hover:bg-[#cc001f] transition duration-300 shadow-md">
                    Download Vyapar Now!
                </button>
            </div>
